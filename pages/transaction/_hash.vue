...
export default {
  ...
  async asyncData ({ $axios, params }) {
    ...
    // Get address
    const getAddress = await $axios.$get(process.env.CACHE_API + '/address/' + params.index)

    // Get tx related to
    const getTxs = await $axios.$get(process.env.CACHE_API + '/transaction/address/' + params.index)
